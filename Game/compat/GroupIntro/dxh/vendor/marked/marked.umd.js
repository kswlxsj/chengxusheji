...
(function (g, f) {
  ...
  var Le = function () {
    ...
    ue = function ue(l) {
      return d(U).replace("hr", q).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("|table", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~~~)[^\\n]*\\n").replace("list", l).replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", H).getRegex();
    },
    De = ue(/ {0,3}(?:[*+-]|1[.)])[ \t]+[^ \t\n]/),
    ve = ue(/ {0,3}(?:[*+-]|\d{1,9}[.)])(?:[ \t]|\n|$)/),
          ...
          for (; n.length > 0;) {
            ...
            if ((k === null || k === void 0 ? void 0 : k.type) === "blockquote") {
              ...
              var _T = k,
                _f = _T.raw + "\n" + n.join("\n"),
                _$ = this.list(_f);
              i[i.length - 1] = _$, s = s.substring(0, s.length - k.raw.length) + _$.raw, r = r.substring(0, r.length - _T.raw.length) + _$.raw, n = _f.substring(i.at(-1).raw.length).split("\n");
              continue;
            }
          }
          return {
        ...
        if (t) {
          ...
          try {
            for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
              ...
              var _p2 = _a2.tokens[0];
              if (_a2.task && ((_p2 === null || _p2 === void 0 ? void 0 : _p2.type) === "text" || (_p2 === null || _p2 === void 0 ? void 0 : _p2.type) === "paragraph")) {
                _a2.text = _a2.text.replace(this.rules.other.listReplaceTask, ""), _p2.raw = _p2.raw.replace(this.rules.other.listReplaceTask, ""), _p2.text = _p2.text.replace(this.rules.other.listReplaceTask, "");
                for (var _h = this.lexer.inlineQueue.length - 1; _h >= 0; _h--) if (this.rules.other.listIsTask.test(this.lexer.inlineQueue[_h].src)) {
                  this.lexer.inlineQueue[_h].src = this.lexer.inlineQueue[_h].src.replace(this.rules.other.listReplaceTask, "");
                  break;
                }
                var _c = this.rules.other.listTaskCheckbox.exec(_a2.raw);
                if (_c) {
                  var _h2 = {
                    type: "checkbox",
                    raw: _c[0] + " ",
                  ...
                  _a2.checked = _h2.checked, r.loose ? _a2.tokens[0] && ["paragraph", "text"].includes(_a2.tokens[0].type) && "tokens" in _a2.tokens[0] && _a2.tokens[0].tokens ? (_a2.tokens[0].raw = _h2.raw + _a2.tokens[0].raw, _a2.tokens[0].text = _h2.raw + _a2.tokens[0].text, _a2.tokens[0].tokens.unshift(_h2)) : _a2.tokens.unshift({
                    type: "paragraph",
                    raw: _h2.raw,
                    text: _h2.raw,
                    tokens: [_h2]
                  }) : _a2.tokens.unshift(_h2);
                }
              } else _a2.task && (_a2.task = !1);
              if (!r.loose) {
                var _c2 = _a2.tokens.filter(function (k) {
                    return k.type === "space";
                  }),
                  _h3 = _c2.length > 0 && _c2.some(function (k) {
                    return _this.rules.other.anyLine.test(k.raw);
                  });
                r.loose = _h3;
              }
            }
      ...
      value: function emStrong(e, t) {
        ...
        if (!(s[1] || s[3] || "") || !n || this.rules.inline.punctuation.exec(n)) {
          ...
          for (c.lastIndex = 0, t = t.slice(-1 * e.length + i); (s = c.exec(t)) !== null;) {
            ...
            if (a -= u, a > 0) continue;
            u = Math.min(u, u + a + p);
            var h = _toConsumableArray(s[0])[0].length,
      ...
      value: function del(e, t) {
        ...
        if (!(s[1] || "") || !n || this.rules.inline.punctuation.exec(n)) {
          ...
          for (p.lastIndex = 0, t = t.slice(-1 * e.length + i); (s = p.exec(t)) !== null;) {
            ...
            if (a -= u, a > 0) continue;
            u = Math.min(u, u + a);
            var c = _toConsumableArray(s[0])[0].length,
    ...
    return _createClass(l, [{
        ...
        var _loop2 = function _loop2() {
            ...
            if ((_this3$options$extens2 = _this3.options.extensions) !== null && _this3$options$extens2 !== void 0 && _this3$options$extens2.startBlock) {
              var _o5 = 1 / 0,
                u = e.slice(1),
                a;
              _this3.options.extensions.startBlock.forEach(function (p) {
                a = p.call({
                  lexer: _this3
      ...
      value: function inlineTokens(e) {
        ...
        if (this.tokens.links) {
          ...
          o.length > 0 && (n = n.replace(this.tokenizer.rules.inline.reflinkSearch, function (u) {
            return o.includes(u.slice(u.lastIndexOf("[") + 1, -1)) ? "[" + "a".repeat(u.length - 2) + "]" : u;
          }));
        }
        n = n.replace(this.tokenizer.rules.inline.anyPunctuation, "++"), n = n.replace(this.tokenizer.rules.inline.blockSkip, function (o, u, a) {
          var p = a ? a.length : 0;
        ...
        var _loop3 = function _loop3() {
            ...
            s || (r = ""), s = !1;
            var o;
            if ((_this4$options$extens = _this4.options.extensions) !== null && _this4$options$extens !== void 0 && (_this4$options$extens = _this4$options$extens.inline) !== null && _this4$options$extens !== void 0 && _this4$options$extens.some(function (a) {
              return (o = a.call({
                lexer: _this4
            ...
            if (o = _this4.tokenizer.del(e, n, r)) {
              e = e.substring(o.raw.length), t.push(o);
              return 1; // continue
            }
            ...
            if ((_this4$options$extens2 = _this4.options.extensions) !== null && _this4$options$extens2 !== void 0 && _this4$options$extens2.startInline) {
              ...
              _this4.options.extensions.startInline.forEach(function (h) {
                c = h.call({
                  lexer: _this4
                }, p), typeof c == "number" && c >= 0 && (_a3 = Math.min(_a3, c));
              }), _a3 < 1 / 0 && _a3 >= 0 && (u = e.substring(0, _a3 + 1));
            }
            if (o = _this4.tokenizer.inlineText(u)) {
              e = e.substring(o.raw.length), o.raw.slice(-1) !== "_" && (r = o.raw.slice(-1)), s = !0;
              var _a4 = t.at(-1);
              (_a4 === null || _a4 === void 0 ? void 0 : _a4.type) === "text" ? (_a4.raw += o.raw, _a4.text += o.text) : t.push(o);
              return 1; // continue
            }
            if (e) {
              _this4.infiniteLoopError(e.charCodeAt(0));
          ...
          if (n.hooks) {
            ...
            var _loop7 = function _loop7(_i8) {
              ...
              var o = _i8,
                u = n.hooks[o],
                a = _r5[o];
              P.passThroughHooks.has(_i8) ? _r5[o] = function (p) {
                if (_this6.defaults.async && P.passThroughHooksRespectAsync.has(_i8)) return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
                  ...
                  return _regenerator().w(function (_context) {
                    while (1) switch (_context.n) {
                      ...
                      case 1:
                        h = _context.v;
                        return _context.a(2, a.call(_r5, h));
                    }
                  }, _callee);
                }))();
                var c = u.call(_r5, p);
                  ...
                  return _regenerator().w(function (_context2) {
                    while (1) switch (_context2.n) {
                      ...
                      case 1:
                        ...
                        _context2.n = 2;
                        return a.apply(_r5, p);
                      case 2:
                        h = _context2.v;
                      case 3:
                        return _context2.a(2, h);
                    }
                  }, _callee2);
                }))();
                var c = u.apply(_r5, p);
                return c === !1 && (c = a.apply(_r5, p)), c;
              };
            };
      ...
      value: function parseMarkdown(e) {
        ...
        return function (n, s) {
          ...
          if (i.hooks && (i.hooks.options = i, i.hooks.block = e), i.async) return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
            var u, p, c, k, _t2, _t3, _t4, _t5, _t6, _t7, _t8, _t9;
            return _regenerator().w(function (_context3) {
              while (1) switch (_context3.n) {
                ...
                case 7:
                  ...
                  _context3.n = 8;
                  return i.hooks.processAllTokens(p);
                case 8:
                  _t5 = _context3.v;
                  _context3.n = 10;
                  break;
                ...
                case 10:
                  ...
                  _context3.n = 11;
                  return Promise.all(_this7.walkTokens(c, i.walkTokens));
                case 11:
                  if (!i.hooks) {
                    _context3.n = 13;
                    break;
          ...
          try {
            ...
            var c = (i.hooks ? i.hooks.provideParser(e) : e ? b.parse : b.parseInline)(a, i);
  ...
  g.defaults = R;
  g.use = function () {
    return z.use.apply(z, arguments), g.defaults = z.defaults, Q(g.defaults), g;
  };
