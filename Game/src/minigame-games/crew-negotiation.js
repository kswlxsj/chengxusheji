(function (Game) {
  ...
  const BACKGROUND_IMAGE = "assets/Image/Scene/Background/crew-negotiation.webp";
  const CREW_PORTRAIT = "assets/Image/Portrait/conductor-crying.webp";
  const PC_PORTRAIT = "assets/Image/Portrait/player.webp";
